 ...
 * @author Jhonatan
 */
public class ListaDePresencaProvaDefesaMemorialTrajetoriaAcademica extends javax.swing.JInternalFrame {

    /**
     * Creates new form ListaDePresençaProvaDefesaMemorialTrajetóriaAcadêmica
     */
    public ListaDePresencaProvaDefesaMemorialTrajetoriaAcademica() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        E.criarListaPresencaProvaDeDefesaMemorialTrajetoriaAcademica(campoData.getText().toString(), campoLocal.getText().toString(), campoObservacoes.getText().toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaDePresencaProvaDefesaMemorialTrajetoriaAcademica.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListaDePresencaProvaDefesaMemorialTrajetoriaAcademica().setVisible(true);
            }
        });
    }
