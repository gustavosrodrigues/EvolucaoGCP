object FormDefesaProjeto: TFormDefesaProjeto
  Left = 187
  Top = 96
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Defesa de memorial de trajet'#243'ria acad'#234'mica'
  ClientHeight = 530
  ClientWidth = 638
  Color = clBtnFace
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet2: TTabSheet
      ...
      object Label2: TLabel
        ...
        Height = 13
        Caption = 
          'Informe a data e o hor'#225'rio das apresenta'#231#245'es da defesa do memori' +
          'al de trajet'#243'ria acad'#234'mica:'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'MS Sans Serif'
    ...
    object TabSheet3: TTabSheet
      ...
      object Label16: TLabel
        ...
        Height = 13
        Caption = 
          'Crit'#233'rios de avalia'#231#227'o da prova de defesa do memorial de trajet'#243 +
          'ria acad'#234'mica:'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
    ...
    object TabSheet4: TTabSheet
      ...
      object Label1: TLabel
        ...
        Height = 13
        Caption = 
          'Local de realiza'#231#227'o da provas de defesa do memorial de trajet'#243'ri' +
          'a acad'#234'mica:'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
      ...
      object Button4: TButton
        ...
        Height = 25
        Caption = 
          'Criar ata de realiza'#231#227'o da prova de defesa de memorial de trajet' +
          #243'ria acad'#234'mica'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'MS Sans Serif'
