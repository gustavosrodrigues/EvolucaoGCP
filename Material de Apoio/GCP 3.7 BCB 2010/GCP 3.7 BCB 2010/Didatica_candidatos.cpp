...
void __fastcall TFormDidaticaCandidatos::Button1Click(TObject *Sender)
{
	if (houve_modificacao) {
		if (Application->MessageBoxA(L"Esta alteração irá apagar qualquer outra configuração de candidatos para a prova Dídática. Deseja continuar?",L"Atenção", MB_YESNO )==ID_YES) {
