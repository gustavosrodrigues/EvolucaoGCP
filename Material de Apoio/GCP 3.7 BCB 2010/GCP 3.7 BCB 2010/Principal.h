...
float peso_escrita_final;   // este é o peso para o cálculo da média
float peso_didatica_final;   // este é o peso para o cálculo da média
float peso_memorial_final;   // este é o peso para o cálculo da média
float peso_titulos_final;    // este é o peso para o cálculo da média
float peso_entrevista_final;  // este é o peso para o cálculo da média
